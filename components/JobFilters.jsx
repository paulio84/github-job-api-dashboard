const JobFilters = () => (
  <div className="font-poppins text-blue-primary text-sm mt-6 lg:mt-8">
    <label className="font-medium" htmlFor="full_time">
